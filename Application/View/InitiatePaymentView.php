...
<form  method="post" action="<?php echo base_url('index.php/StudentFeeController/verifystudentforpay'); ?>">
...
<br>
<?php if ($student): ?>
<form  method="post" action="<?php echo base_url('index.php/StudentFeeController/loadstudentfeeview'); ?>">
...
<input type = "hidden" name="courseid" value = "<?php echo $student->courseid; ?>"></input>
<input type = "hidden" name="coursename" value = "<?php echo $student->coursename; ?>"></input>
	<div class="section"><input type="submit" name="submit" value="Pay"></input></div>
</div>
</form>
