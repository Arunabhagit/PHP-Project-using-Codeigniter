...
<form  method="post" action="<?php echo base_url('index.php/teacherAttendenceController/saveteacherattendence'); ?>">

<center><h2>Teacher Attendance Details </h2>
</center><br>
...
<table class="table-container" style="margin: 0 auto;border-collapse: collapse; width: 80%;background-color: white;">
	...
	foreach ($tecattn as $onetecattn):
$randid = mt_rand(1,100);?>
                <tr>
                    <td style="padding: 10px;border: 1px solid #ddd;"><?php echo $onetecattn->time; ?></td>
                    <td style="padding: 10px;border: 1px solid #ddd;"><?php echo $onetecattn->onetecattn; ?></td>
...
<input type="hidden" name= "time[]" value="<?php echo $onetecattn->time;?>" >
<input type="hidden" name= "teachername[]" value="<?php echo $onetecattn->teachername;?>" >
<input type="hidden" name= "teacherid[]" value="<?php echo $onetecattn->teacherid;?>" >		
                </tr>
            <?php endforeach; ?>
</tbody>
        </table>
