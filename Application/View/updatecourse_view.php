...
<form  method="post" action="<?php echo base_url('index.php/CourseController/updatecoursedetails'); ?>">
...
<label id="coursename">Course Name:</label><input type="text"  name= "coursename" value="<?php echo $course->coursename; ?>" required ><br><br>
<label id="duration">Duration:</label><input type="text"  name= "duration" value="<?php echo $course->duration; ?>" required><br><br>
<label id="totalfee">Total Fee:</label><input type="text" name="totalfee" value="<?php echo $course->totalfee; ?>" required><br><br></div>

 
  <div class="section">
  <label id="monthlyfee"> Monthly Fee:</label><input type="text"  name= "monthlyfee" value="<?php echo $course->monthlyfee; ?>" required><br><br>
 
 <label id="admissionfee">Admission Fee:</label><input type="text"  name= "admissionfee" value="<?php echo $course->admissionfee; ?>" required><br><br>
 <label id="coursesub">Course Sub:</label><input type="text"  name= "coursesub" value="<?php echo $course->coursesub; ?>" required><br><br>
