...
<div class = "maincontainer">
  ...
  <form method="post" action="<?php echo base_url('index.php/CourseController/searchcoursebycid'); ?>">
...
<?php if ($course): ?>
<form  method="post" action="<?php echo base_url('index.php/CourseController/loadcoursedetails'); ?>">
