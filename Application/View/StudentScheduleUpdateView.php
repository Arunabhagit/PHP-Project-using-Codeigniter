...
<div class = "maincontainer">
  ...
  <form id="scheduleForm" action="<?php echo base_url('index.php/StudentAssignmentController/updateclassassignment'); ?>" method="post">
...
<label for="studentname">Course ID:</label>
	<input type="text" name= "stdnamedis" value="<?php echo $courseid;?>" disabled>
<label for="studentname">Course Name:</label>
	<input type="text" name= "stdnamedis" value="<?php echo $coursename;?>" disabled>
...
<input type="hidden" name= "coursename" value="<?php echo $coursename;?>">
 ...
 <table class="table-container" style="margin: 0 auto;border-collapse: collapse; width: 80%;background-color: white;">
	<thead>
            <tr>
		<th style="background-color: #f2f2f2;color: #333;padding: 10px;border: 1px solid #ddd;">Present Days</th>
                <th style="background-color: #f2f2f2;color: #333;padding: 10px;border: 1px solid #ddd;">Present Times</th>

</tr></thead><tbody>
<?php foreach ($stdassignment as $oneassignment):?>
<tr>
<td style="padding: 10px;border: 1px solid #ddd;text-align:center"><?php echo $oneassignment->day;?></td>
                    <td style="padding: 10px;border: 1px solid #ddd;text-align:center"><?php echo $oneassignment->time;?></td>
<?php endforeach;?>
</tbody>
        </table>

<div id="fieldContainer">
<div><?php foreach ($stdassignment as $oneassignment):?>
	<div  class ="skycontainer">

    <div class="section">
      <!-- Initial fields for day and time -->
      <input type="hidden" name= "assignmentid[]" value="<?php echo $oneassignment->assignmentid;?>">
...
<?php endforeach;?>
  ...
  <script>
    function addField() {
      ...
      newField.innerHTML = `
        <div  class ="container"><div class="section"><label for="day">Day:</label>
        <!--<input type="text" name="day[]" required>-->
	<select id="day" name="day[]">
	<option value="Sunday">Sunday</option>
<option value="Monday">Monday</option>
